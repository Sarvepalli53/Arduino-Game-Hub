...
#define PLAYER_WAIT_TIME 3000 // The time allowed between button presses -3s 
...
byte noPins = 4; // Number of buttons/LEDs (While working on this, I was using only 2 LEDs)
 ...
 // You could make the game harder by adding an additionalLED/button/resistors combination.
...
//button
 ...
 Serial.print("Read: "); // Serial Monitor Output - Should be removed ifyou removed the Serial.begin above
